 ...
 */
package com.msw.masla.core.async.producer;
...
public class BasicAsyncRequestProducer implements HttpAsyncRequestProducer {
     ...
     * @param response response client.
     */
    public BasicAsyncRequestProducer(
            final HttpHost target,
            final HttpEntityEnclosingRequest request,
            final HttpAsyncContentProducer producer,HttpServletResponse response) {
        super();
     ...
     * @param request request message.
     */
    public BasicAsyncRequestProducer(final HttpHost target, final HttpRequest request, HttpServletResponse response) {
        Args.notNull(target, "HTTP host");
        Args.notNull(request, "HTTP request");
        this.target = target;
        this.request = request;
