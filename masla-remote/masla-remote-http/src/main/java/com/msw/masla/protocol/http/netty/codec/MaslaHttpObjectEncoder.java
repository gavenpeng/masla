 ...
 */
public abstract class MaslaHttpObjectEncoder<H extends HttpMessage> extends MessageToMessageEncoder<Object> {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(MaslaHttpObjectEncoder.class);
...
//                            p = ctx.newPromise();
//                        }
                        Object mss = out.getUnsafe(i);
                        ctx.write(mss, voidPromise);
                    }
                    Object mss = out.getUnsafe(sizeMinusOne);
                    ctx.write(mss, promise);
                }
                out.recycle();
            }
        }
    ...
    protected void encode(ChannelHandlerContext ctx, Object msg, List<Object> out) throws Exception {
        ...
        if (msg instanceof HttpMessage) {
            ...
            if(LOG.isDebugEnabled()){
                LOG.debug("state = {},chunked header = {}",state,m.headers().get(HttpHeaderNames.TRANSFER_ENCODING));
            }
