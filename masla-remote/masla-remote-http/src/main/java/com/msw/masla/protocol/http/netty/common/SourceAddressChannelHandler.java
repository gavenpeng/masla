...
package com.msw.masla.protocol.http.netty.common;
...
public class SourceAddressChannelHandler extends ChannelInboundHandlerAdapter
{
    ...
    public static final int INBOUND_TCP_PASSTHROUGH__PORT = 10102;
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception
    {
        ...
        if (INBOUND_TCP_PASSTHROUGH__PORT == ctx.channel().attr(ATTR_LOCAL_PORT).get()) {
